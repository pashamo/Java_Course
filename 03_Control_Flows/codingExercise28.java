...
public class codingExercise28 {
  public static void main(String[] args) {
    System.out.println("-----codingExercise28-----");
  ...
  public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
    ...
    double estimateBuckets = Math.ceil(areaToPaint/areaPerBucket);
    //System.out.println("estimateBuckets: "+estimateBuckets);
    int actualBuckets = (int)(estimateBuckets-extraBuckets);
    //System.out.println("actualBuckets: "+actualBuckets);
  ...
  public static int getBucketCount(double width, double height, double areaPerBucket) {
    ...
    double estimateBuckets = Math.ceil(areaToPaint/areaPerBucket);
    //System.out.println("estimateBuckets: "+estimateBuckets);
    int actualBuckets = (int)estimateBuckets;
    //System.out.println("actualBuckets: "+actualBuckets);
  ...
  public static int getBucketCount(double area, double areaPerBucket) {
    ...
    double estimateBuckets = Math.ceil(area/areaPerBucket);
    //System.out.println("estimateBuckets: "+estimateBuckets);
    int actualBuckets = (int)estimateBuckets;
    //System.out.println("actualBuckets: "+actualBuckets);
